...
def write_copycount_jf_to_file(vertex_f, copycount_f):
    ...
    os.system("cat {0} | cut -f2 -d\" \" | jellyfish query -i {1}  | cut -f2 -d \" \" > {2}".format(vertex_f, JF_FILE, copycount_f))
...
def write_neikmer_jf_to_file(NEIKMER_FILE):
    ...
    returned_value = os.system("cat invalidnei1.txt | jellyfish query -i {0} > neikmer1.tmp".format(JF_FILE))
