...
with open(genomesset, 'r') as reader:
    ...
    while line != '':  # The EOF char is an empty string
        line=line.rstrip()
#        print("The string: ", line, end='')
        firstkmer = line[0:k]
        lastkmer = line[len(line)-k:]
        countf = 0
        countl = 0
        ...
        cond3 = False
#        print("Last kmer: ", lastkmer)
#        print("Unitig: ", unitig)
#        print(countl, findindex_l, len(unitig))
